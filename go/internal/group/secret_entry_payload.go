...
func (s *SecretEntryPayload) DecryptSecret(localMemberPrivateKey crypto.PrivKey, group *Group) (*DeviceSecret, error) {
...
func (s *SecretEntryPayload) GetDevicePubKey() (crypto.PubKey, error) {
